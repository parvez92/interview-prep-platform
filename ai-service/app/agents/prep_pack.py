...
SYSTEM = """You are a technical interview specialist. Create a targeted preparation pack
for a specific job opportunity. Use tools to retrieve the candidate's current progress
and search their background. Be specific and actionable."""


async def run_prep_pack(
    user_id: int,
    job_description: str,
    company: str,
    role: str,
